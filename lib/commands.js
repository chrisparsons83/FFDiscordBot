      ...
      if (Object.keys(target_year_data).indexOf(teamname) > -1) {
        ...
        */
        ...
        sorted_receptions.forEach((item, index) => {
          average_reception_node = average_data[item.position + 'RecPercent']
          receptions_str += "- " + item.position.toUpperCase() + ": " + item.receptions + " receptions  ( " + average_data["receptions"]  + " receptions )\n";
        });
