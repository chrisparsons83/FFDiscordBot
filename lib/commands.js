...
commands['!choose'] = args => new Promise((resolve, reject) => {
  if (!args) {
    ...
    // if args starts with a comma
    // temp message i used for now, can't think of anything
    reject('Invalid request. Please use the commas properly.');
  } else {
...
//  reserved command for vegas odds
/*
commands['!odds] = string => new Promise((resolve, reject) => {
})
*/
