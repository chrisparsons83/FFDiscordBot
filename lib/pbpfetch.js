...
const nflSavantUrl = 'http://nflsavant.com/pbp_data.php?year=2018';
...
function writeToJson(leagueAverage, teamStats) {
  fs.writeFile('../stats/leagueAverage2018.json', JSON.stringify(leagueAverage, null, 2), () => {
    console.log('Writing to league average json done.')
  });
  fs.writeFile('../stats/teamstats2018.json', JSON.stringify(teamStats, null, 2), () => {
