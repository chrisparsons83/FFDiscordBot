...
const playerExceptions = [
  ...
  { name: 'javorius allen', url: 'http://www.rotoworld.com/player/nfl/10314/buck-allen' },
  ...
  { name: 'chris thompson', url: 'http://www.rotoworld.com/player/nfl/8563/chris-thompson' },
  { name: 'gronk', url: 'http://www.rotoworld.com/player/nfl/5729/rob-gronkowski' },
  { name: 'ben watson', url: 'http://www.rotoworld.com/player/nfl/48/ben-watson' },
  { name: 'benjamin watson', url: 'http://www.rotoworld.com/player/nfl/48/ben-watson' },
  { name: 'charles clay', url: 'http://www.rotoworld.com/player/nfl/6681/charles-clay' },
  { name: 'robert woods', url: 'http://www.rotoworld.com/player/nfl/8407/robert-woods' },
  { name: 'juju smith-schuster', url: 'http://www.rotoworld.com/player/nfl/12184/juju-smith-schuster' },
  { name: 'juju smith schuster', url: 'http://www.rotoworld.com/player/nfl/12184/juju-smith-schuster' },
  { name: 'trashcan', url: 'http://www.rotoworld.com/player/nfl/6491/cam-newton' },
  { name: 'trashcam', url: 'http://www.rotoworld.com/player/nfl/6491/cam-newton' },
  { name: 'dougie fresh', url: 'http://www.rotoworld.com/player/nfl/7426/doug-martin' },
  { name: 'douggernaut', url: 'http://www.rotoworld.com/player/nfl/7426/doug-martin' },
  { name: 'dmcutsemoji', url: 'http://www.rotoworld.com/player/nfl/7426/doug-martin' },
  { name: 'tygod', url: 'http://www.rotoworld.com/player/nfl/6509/tyrod-taylor' },
  { name: 'josh allen', url: 'http://www.rotoworld.com/player/nfl/13045/josh-allen' },
  { name: 'aj mccarron', url: 'http://www.rotoworld.com/player/nfl/9290/aj-mccarron' },
  { name: 'justin jackson', url: 'http://www.rotoworld.com/player/nfl/13350/justin-jackson' },
];
...
exports.getPlayer = playerName => new Promise((resolve, reject) => {
  ...
  if (playerName.includes('<:')) {
    // strip everything out except for alphabets
    playerName = `${playerName.toLowerCase().replace(/[^a-z]/gi, '')}emoji`;
  }
