...
const playerExceptions = [
    ...
    { name: 'shady', url:'http://www.rotoworld.com/player/nfl/5168/lesean-mccoy'},
];

exports.getPlayer = function (playerName) {
    return new Promise(function (resolve, reject) {
        // declare some variables
        let url, playerStringQuery, playerQueryFirst, playerQueryLast, playerSearch = '';
        ...
        getPlayerExceptions = playerExceptions.filter((value) => {
            ...
            return value.name.toLowerCase() === playerSearch;
        });
