...
const getStats = (stats, league) => {
  ...
  object.yardsPerPass = `**${getAvg(passYds, pass)} yds/att** (${getAvg(leaguePassYds, leaguePass)})`;
  ...
  object.yardsPerRush = `**${getAvg(rushYds, rush)} yds/att** (${(leagueRushYds / leagueRush).toFixed(2)})`;
