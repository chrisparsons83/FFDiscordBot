...
utilities.list_order = ['pts_std', 'pts_ppr', 'pts_half_ppr', 'td',
                        'rush_td', 'rec_td', 'rush_yd', 'rush_att', 'rush_ypa', 'rec', 'pass_yd', 'rec_ypr', 'rec_yd', 'rec_ypt',
                        'rec_tgt', 'rec_pct', 'bonus_rush_rec_yd_100', 'bonus_rush_yd_100', 'bonus_rush_att_20', 'fum_lost', 'fum', 'gs', 'gp', 'gms_active'];

utilities.notinclude = ['humidity', 'wind_speed', 'temperature', 'tm_st_snp', 'bonus_rec_rb', 'rush_fd', 'rush_lng',
...
utilities.notinclude_stats = ['humidity', 'wind_speed', 'temperature', 'tm_st_snp', 'bonus_rec_rb', 'rush_fd', 'rush_lng',
                        'rec_lng', 'rec_fd', 'pass_fd', 'pass_lng', 'off_snp', 'cmp_pct', 'tm_off_snp', 'bonus_pass_cmp_25',
                        'pass_rtg', 'pass_sack_yds', 'tm_def_snp', 'pass_int_td', 'st_snp', 'pr_lng', 'bonus_pass_yd_300', 'pass_cmp_40p',
                        'def_snp', 'gs', 'gp', 'gms_active', 'bonus_rush_rec_yd_100', 'bonus_rush_yd_100', 'bonus_rush_att_20'];

utilities.notinclude_projections = ['humidity', 'wind_speed', 'temperature', 'tm_st_snp', 'bonus_rec_rb', 'rush_fd', 'rush_lng',
                        'rec_lng', 'rec_fd', 'pass_fd', 'pass_lng', 'off_snp', 'cmp_pct', 'tm_off_snp', 'bonus_pass_cmp_25', 'bonus_rush_rec_yd_100',
                        'pass_rtg', 'pass_sack_yds', 'tm_def_snp', 'pass_int_td', 'st_snp', 'pr_lng', 'bonus_pass_yd_300', 'pass_cmp_40p',
                        'def_snp', 'rush_ypa', 'rush_yd', 'rush_att', 'rec_ypt', 'rec_ypr', 'rec_yd', 'rec_pct', 'gs', 'gp', 'gms_active', 'fum_lost', 'fum', 'rec_tgt'];
...
utilities.convert_stats = {
  ...
  'pass_ypc': 'Passing yd/reception',
  'pass_ypa': 'Passing yd/attempt',
  ...
  'idp_tki_loss': 'Tackles for a Loss',
  ...
  'pr': 'Punt Returns',
  'idp_tkl_solo': 'IDP Solo Tackles',
  'idp_tki_loss': 'IDP Tackles for a Loss',
  'idp_tkl_ast': 'IDP Tackles (Assist)',
  'idp_tkl': 'IDP Total Tackle',
  'ssack_yd': 'IDP Sack Yards',
  'idp_sack': 'IDP Sacks',
  'idp_qb_hit': 'IDP QB Hits',
  'idp_int': 'IDP Interceptions',
  'idp_fum_rec': 'IDP Fumble Recoveries',
  'idp_ff': 'IDP Fumbles Forced',
  'fum_ret_yd': 'IDP Fumble Return Yds'
}
