...
describe('4for4 Utilities', function () {
    ...
    it('Should return the team name for a player', () => {
        return lib4for4.getADP(validPlayer).then(function (value) {
    ...
    it('Should return the ESPN ranking for a player', () => {
        return lib4for4.getADP(validPlayer).then(function (value) {
    ...
    it('Should return the Yahoo ranking for a player', () => {
        return lib4for4.getADP(validPlayer).then(function (value) {
    ...
    it('Should return the MFL ranking for a player', () => {
        return lib4for4.getADP(validPlayer).then(function (value) {
    ...
    it('Should return the NFL ranking for a player', () => {
        return lib4for4.getADP(validPlayer).then(function (value) {
